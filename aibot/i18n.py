...
T = {
    "kz": {
        ...
        "menu_lang": "🌐 Тіл",
        "ask_format": "📐 Сурет форматын таңдаңыз:",
        "ask_prompt_image_fmt": "✍️ Формат: {fmt}. Енді суретті сипаттаңыз (мыс. «тауда ұшқан алтын бүркіт»).",
        ...
        "menu_buy": "💎 Сатып алу",
        "buy_title": "💎 Жазылым алыңыз — барлық мүмкіндік ашылады (шексіз сурет + біріктіру + жандандыру). Төлем Telegram Stars арқылы:",
        "sub_week": "📅 1 апта",
        "sub_month": "📆 1 ай",
        "sub_invoice_title": "{name} жазылым",
        "sub_invoice_desc": "{name} ішінде БАРЛЫҚ мүмкіндік: шексіз сурет + біріктіру + жандандыру.",
        "pay_success_sub": "✅ Төлем сәтті! {name} жазылым қосылды — барлық мүмкіндік ашық! 🎉",
        "sub_active": "💎 Жазылым белсенді: {until} дейін",
        "need_credit": "🔒 Бұл — ақылы мүмкіндік.",
        "need_sub": "🔒 Бұл мүмкіндік жазылыммен ашылады. Төмендегі жазылымды таңдаңыз 👇",
    ...
    "ru": {
        ...
        "menu_lang": "🌐 Язык",
        "ask_format": "📐 Выберите формат изображения:",
        "ask_prompt_image_fmt": "✍️ Формат: {fmt}. Теперь опишите изображение (напр. «золотой орёл в горах»).",
        ...
        "menu_buy": "💎 Купить",
        "buy_title": "💎 Оформите подписку — откроется всё (безлимит фото + объединение + оживление). Оплата через Telegram Stars:",
        "sub_week": "📅 1 неделя",
        "sub_month": "📆 1 месяц",
        "sub_invoice_title": "Подписка {name}",
        "sub_invoice_desc": "На период «{name}» — всё: безлимит фото + объединение + оживление.",
        "pay_success_sub": "✅ Оплата успешна! Подписка {name} активна — доступно всё! 🎉",
        "sub_active": "💎 Подписка активна до: {until}",
        "need_credit": "🔒 Это платная функция.",
        "need_sub": "🔒 Эта функция открывается по подписке. Выберите подписку ниже 👇",
    ...
    "en": {
        ...
        "menu_lang": "🌐 Language",
        "ask_format": "📐 Choose the image format:",
        "ask_prompt_image_fmt": "✍️ Format: {fmt}. Now describe the image (e.g. 'a golden eagle in the mountains').",
        ...
        "menu_buy": "💎 Buy",
        "buy_title": "💎 Get a subscription — everything unlocks (unlimited images + combine + animate). Pay via Telegram Stars:",
        "sub_week": "📅 1 week",
        "sub_month": "📆 1 month",
        "sub_invoice_title": "{name} subscription",
        "sub_invoice_desc": "For the '{name}' period — everything: unlimited images + combine + animate.",
        "pay_success_sub": "✅ Payment successful! {name} subscription is active — everything unlocked! 🎉",
        "sub_active": "💎 Subscription active until: {until}",
        "need_credit": "🔒 This is a paid feature.",
        "need_sub": "🔒 This feature is unlocked with a subscription. Choose one below 👇",
