...
T = {
    "kz": {
        ...
        "menu_buy": "💎 Сатып алу",
        "buy_title": "💎 Жазылым таңдаңыз — төлем Telegram Stars арқылы. Жазылым кезінде ШЕКСІЗ қолданасыз:",
        "sub_week": "📅 1 апта",
        "sub_month": "📆 1 ай",
        "sub_invoice_title": "{name} жазылым",
        "sub_invoice_desc": "{name} ішінде шексіз генерация (сурет/видео/жаңарту/аватар/жандандыру).",
        "pay_success_sub": "✅ Төлем сәтті! {name} жазылым қосылды — енді шексіз қолданыңыз! 🎉",
    ...
    "ru": {
        ...
        "menu_buy": "💎 Купить",
        "buy_title": "💎 Выберите подписку — оплата через Telegram Stars. Во время подписки — БЕЗЛИМИТ:",
        "sub_week": "📅 1 неделя",
        "sub_month": "📆 1 месяц",
        "sub_invoice_title": "Подписка {name}",
        "sub_invoice_desc": "Безлимитная генерация на период «{name}» (фото/видео/восстановление/аватар/анимация).",
        "pay_success_sub": "✅ Оплата успешна! Подписка {name} активна — пользуйтесь без лимита! 🎉",
